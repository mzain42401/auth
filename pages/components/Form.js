        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" onSubmit={formSubmit} >
            <div>
              ...
              <div  > 
              {error==="User already exists" && <p className='text-red-600 text-sm mt-1'>{error}</p>} </div>
            <div>  {error==="user not found" && <p className='text-red-600 text-sm mt-1'>{error}</p>} </div>
            ...
            <div>  {error==="incorrect password" && <p className='text-red-600 text-sm mt-1 '>{error}</p>} </div>
            </div>
            <div className="flex items-center justify-between">
